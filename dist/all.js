...
(function(global) {
    ...
    var stateProperties = fabric.Object.prototype.stateProperties.concat();
    stateProperties.push("fontFamily", "fontWeight", "fontSize", "text", "textDecoration", "textAlign", "fontStyle", "lineHeight", "backgroundColor", "textBackgroundColor", "useNative", "path");
...
(function() {
    ...
    function request_fs(url, callback) {
        var fs = require("fs"), body = fs.readFileSync(url);
        callback(body);
    }
